...
public class Tutorial23 {
	...
	public void setup(@Optional("7.0.0")String verion) throws MalformedURLException {
		
		System.out.println("Session is creating");
		DesiredCapabilities cap = new DesiredCapabilities();
		cap.setCapability("platformName", "Android");
		//cap.setCapability("deviceName", "Samsung");
		//cap.setCapability("deviceName", "Goole Nexus 9");
		cap.setCapability("app", System.getProperty("user.dir") + "/src/test/resources/app/ApiDemos.apk");

		if (verion.equals("6.0")) {
			
			cap.setCapability("deviceName", "Goole Nexus 9");

			cap.setCapability("udid", "192.168.233.103:5555");
			
		} else if (verion.equals("7.0")) {
			cap.setCapability("deviceName", "Samsung");
			cap.setCapability("udid", "192.168.233.102:5555");
